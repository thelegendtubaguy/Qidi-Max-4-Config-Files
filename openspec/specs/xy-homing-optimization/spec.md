# xy-homing-optimization Specification

## Purpose

X/Y homing optimization controls first- and second-strike speeds, controller transition waits, axis-specific dwell, and retained closed-loop safety behavior.
