# guarded-klipper-source-patching Specification

## Purpose

Firmware-scoped source patching controls guarded vendor Python deployment, installed-state provenance, backup, rollback, restore, and uninstall.
